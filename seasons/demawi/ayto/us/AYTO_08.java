...
public class AYTO_08
   ...
   public AYTO_08() {
      super(new PermutationConfiguration(Mode.BISEXUAL), 8);
      ...
      newDay().matchBox(pair(Remy, Brandon), false)
      ...
      newDay().matchBox(pair(Jenna, Kai), false)
      ...
      newDay().matchBox(pair(Danny, Jenna), false)
      ...
      newDay().matchBox(pair(Kari, Kylie), false)
      ...
      newDay().matchBox(pair(Aasha, Brandon), true)
      ...
      newDay().matchBox(pair(Jasmine, Jenna), false)
      ...
      newDay().matchBox(pair(Paige, Remy), false)
      ...
      newDay().matchBox(pair(Amber, Max), false)
      ...
      newDay().matchBox(pair(Amber, Kylie), false)
   ...
   public static void main(String[] args) {
      new DefaultMatchPrinter(new AYTO_08()).printLastDayResults();
   }
