   ...
   public AYTO_VIP05() {
      ...
      newDay().matchBox(pair(Antonia, Olli), false)
            ...
            .matchNight(5, pair(Elli, Xander), pair(Sandra, Lennert), pair(Hati, Jonny), pair(Antonia, Calvin_Blond_S),
                  pair(Joanna, Sidar), pair(Nelly, Rob), pair(Ariel, Leandro), pair(Henna, Olli), pair(Viki, Kevin),
                  pair(Beverly, Nico)); // Jimi, Calvin_hOt
      ...
      newDay().matchBox(pair(Nelly, Calvin_hOt), null)
            .matchNight(4, pair(Elli, Xander), pair(Sandra, Lennert), pair(Nelly, Calvin_hOt), pair(Viki, Rob),
                  pair(Henna, Olli), pair(Ariel, Leandro), pair(Hati, Kevin), pair(Beverly, Sidar),
                  pair(Antonia, Jonny), pair(Joanna, Calvin_Blond_S)); // Jimi, Nico
      newDay().matchBox(pair(Nelly, Calvin_hOt), true)
            .matchBox(pair(Joanna, Calvin_Blond_S), false)
