...
public class AYTO_1
   ...
   public AYTO_1() {
      ...
      newTag().matchBox(false, pair(Ivana, Mo))
      ...
      newTag().matchBox(false, pair(Melissa, Dominic))
      ...
      newTag().matchBox(true, pair(Aline, Mo))
      ...
      newTag().matchBox(true, pair(Melissa, Laurin))
      ...
      newTag().matchBox(false, pair(Ivana, Elisha))
      ...
      // 7ter Tag
      newTag().matchBox(false, pair(Ivana, Edin))
      ...
      // 8ter Tag
      newTag().matchBox(false, pair(Ivana, Kevin))
      ...
      // 9ter Tag
      newTag().matchBox(false, pair(Maddie, Ferhat))
      ...
      // 10ter Tag
      newTag().matchBox(true, pair(Katharina, Kevin))
