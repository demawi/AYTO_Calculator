...
public class AYTO_VIP02
   ...
   public AYTO_VIP02() {
      ...
      newTag().matchBox(false, pair(Zoe, Martin))
      ...
      newTag().matchBox(false, pair(Karina, Pharrell))
      ...
      newTag().matchBox(false, pair(Celina, Lukas))
      ...
      newTag().matchBox(false, pair(Isabelle, Pharrell))
      ...
      newTag().matchBox(true, pair(Cecilia, Amadu))
      ...
      newTag().matchBox(true, pair(Anna, Michael))
      ...
      newTag().matchBox(false, pair(Ricarda, Pharrell))
      ...
      newTag().matchBox(false, pair(Franziska, Max))
   ...
   public static void main(String[] args) {
      new EventbasedMatchPrinter().printDayResults(new AYTO_VIP02());
   }
