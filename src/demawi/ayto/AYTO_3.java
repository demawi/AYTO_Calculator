...
public class AYTO_3
  ...
  public AYTO_3() {
    ...
    newTag().matchBox(false, pair(Jessica, Mike))
    ...
    newTag().matchBox(false, pair(Monami, Leon))
    ...
    newTag().matchBox(false, pair(Raphaela, Andre))
    ...
    newTag().matchBox(null, pair(Dana, William))
    ...
    newTag().addNew(Desiree)
          .matchBox(false, pair(Monami, Antonino))
    ...
    // 7ter Tag
    newTag().matchBox(true, pair(Zaira, Marius))
    ...
    // 8ter Tag
    newTag().matchBox(false, pair(Raphaela, Jordi))
    ...
    // 9ter Tag
    newTag().matchBox(false, pair(Kerstin, Max))
    ...
    // 10ter Tag
    newTag().matchBox(false, pair(Isabelle, Dustin))
  ...
  public static void main(String[] args) {
    new EventbasedMatchPrinter().printDayResults(new AYTO_3());
  }
